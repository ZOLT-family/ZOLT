...
> The first launch odds market on Robinhood Chain. Yes/No on whether a Pons launch graduates in time, settled by the chain itself. Unaudited. Not for US persons.

(158 characters.)

Shorter, if the field is tight:

> The first launch odds market on Robinhood Chain. Settled by the chain, not by us. Unaudited.
...
- Never "audited", "guaranteed", "risk-free", "insured".
...
- Every post that names the contract names the state: unaudited; deployed or not.
